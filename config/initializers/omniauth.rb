...
Rails.application.config.middleware.use OmniAuth::Builder do
  ...
  provider :facebook, '490436137808844', '720a669eb670b706b6641b0f7cb6505b', {:scope => 'email', :display => 'popup', :info_fields => 'name,email',:client_options => {:ssl => {:ca_file => Rails.root.join("cacert.crt").to_s}}}
end